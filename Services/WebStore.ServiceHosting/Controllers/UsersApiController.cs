...
namespace WebStore.ServiceHosting.Controllers
{
	...
	public class UsersApiController : ControllerBase
	{
		...
		[HttpPost("AddClaims")]
		public async Task AddClaimsAsync([FromBody] AddClaimsDto ClaimInfo, [FromServices] WebStoreDB db)
		{
		...
		public async Task ReplaceClaimAsync([FromBody] ReplaceClaimsDto ClaimInfo, [FromServices] WebStoreDB db)
		{
		...
		public async Task RemoveClaimsAsync([FromBody] RemoveClaimsDto ClaimInfo, [FromServices] WebStoreDB db)
		{
